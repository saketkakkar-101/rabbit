        ...
        <table className='min-w-full text-left text-gray-500'>
         <thead className='bg-gray-100 text-xs uppercase text-gray-700'> 
           <tr>
            ...
            <th className='py-2 px-4 sm:py-3'>shiiping Address</th>
...
//   // Destructure the state, ensuring it falls back to default values if state is undefined
...
//                   </td>
//                   <td className='py-2 px-2 sm:py-4 sm:px-4'>
//                     <span className={`${order.isPaid ? "bg-green-100 text-gray-700" : "bg-red-100 text-red-700"} px-2 py-1 rounded-full text-xs sm:text-sm font-medium`}>
//                       {order.isPaid ? "Paid" : "Pending"}
//                     </span>
//                   </td>
//                 </tr>
