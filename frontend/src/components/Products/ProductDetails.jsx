...
//     const { id } = useParams(); // Directly use the id from useParams
//     const dispatch = useDispatch();
//     const { selectedProduct, loading, error, similarProducts } = useSelector(
//         (state) => state.products
//     );
...
//     useEffect(() => {
//         if (id) {
//             dispatch(fetchProductDetails(id)); // Fetch product details using `id`
...
//         dispatch(
//             addToCart({
//                 productId: id, // Use the `id` from the URL directly
//                 quantity,
//                 size: selectedSize,
//                 color: selectedColor,
//                 guestId,
